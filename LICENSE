...
Stéphane Lenclud ("Slion") may publish revised and/or new versions of the
...
License published by Slion. No one other than Slion has the right to
...
License), You must (a) rename Your license so that the phrases "Slion",
